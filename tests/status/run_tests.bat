@echo off
setlocal
rem Standalone formatter/speech checks; never opens the game or speech backend.
rem Usage: run_tests.bat [path\to\acc_status.c]
...
set "TEST_SOURCE=%TEST_PROJECT%\src\access\acc_status.c"
